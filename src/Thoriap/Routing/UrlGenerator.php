...
use Thoriap\Http\Request;
use Thoriap\Config\Repository;
use Thoriap\Routing\Router;
...
class UrlGenerator {
    ...
    public function administrator($url = null, array $parameters = array(), $escape = false)
    {
        ...
        $administrator_directory = $this->config->get('application.administrator_directory');

        return $this->to($administrator_directory.'/'.$url, $parameters, $escape);
